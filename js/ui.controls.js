    ...
    drawBarGraph: function() {
        ...
        for(var i = 0; i < importLabelArray.length; i++) {
            ...
            if(pieceHeight < smallLabelSize) {
                ...
                var textLabel = importLabel.append('text').text('REFUGEES').attr('text-anchor','end').attr('y',15)
                ...
                labelWidth = numericLabelEle.getComputedTextLength() > textLabelEle.getComputedTextLength() ? numericLabelEle.getComputedTextLength() : weaEle.getComputedTextLength();
            } else {
                ...
                var textLabel = importLabel.append('text').text('REFUGEES').attr('text-anchor','end').attr('y',8).attr('class',function(d) { return 'import '+d.type});
                var weaponLabel  =importLabel.append('text').text(' ').attr('text-anchor','end').attr('y',8) //WEAPONS
                    .attr('class',function(d) { return'import '+d.type} );
                labelHeight = fontSizeInterpolater((data.amount-minImExAmount)/(maxImExAmount-minImExAmount));
        ...
        for(var i = 0; i < exportLabelArray.length; i++) {
            ...
            if(pieceHeight < smallLabelSize) {
                ...
                var textLabel = exportLabel.append('text').text('REFUGEES')
                    .attr('text-anchor','start').attr('y',15).attr('class',function(d) { return 'export '+d.type});
                labelHeight = fontSizeInterpolater((data.amount-minImExAmount)/(maxImExAmount-minImExAmount));
                labelBGYPos = -labelHeight;
                labelHeight += 16;
                ...
                var textLabel = exportLabel.append('text').text('REFUGEES').attr('text-anchor','start').attr('y',8).attr('class',function(d) { return 'export '+d.type});
                var weaponLabel  =exportLabel.append('text').text(' ').attr('text-anchor','start').attr('y',8) //WEAPONS
